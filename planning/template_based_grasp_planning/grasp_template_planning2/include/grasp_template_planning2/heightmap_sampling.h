...
#include <grasp_template_planning2/grasp_template_params.h>
#include <grasp_template_planning2/height_value_extractor.h>
#include <grasp_template_planning2/template_heightmap.h>
